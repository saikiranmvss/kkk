                                        ...
                                        <h6 for="primary-colors" class="title-card">SIZES</h6>
                                            <div class="col-md-12">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control mt-2" id="slab-jumbo" placeholder="Jumbo Size" value="">
                                                    <input type="text" class="form-control mt-2" id="slab-superjumbo" placeholder="Super Jumbo size" value="">
    ...
    $('.preview-div-'+id).remove();
            ...
            const detailSubmit = ()=>{
                ...
                if(prodName=='' || primColor=='' || stoneCat=='' || prodOrigin=='' || prodSku=='' || prodSeries=='' || prodFinish.length==0 || slabId1=='' || priceRange=='' ) {
                    ...
                    let postData={prodName, primColor , stoneCat , prodOrigin , prodSeries,prodFinishs , prodSku, priceRange,slabSize1, slabId1, slabSize2, flooringResidential , flooringCommercial ,slabSuperJumbo, slabJumbo , counterResidential , counterCommercial , wallResidential , wallCommercial , exterior , formName : "productUpload" };
